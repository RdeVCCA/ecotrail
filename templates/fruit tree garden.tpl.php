...
<body>
	...
	<section class="grid-container">
		...
		<div class="grid-item" id = "root_image" data-aos="fade-left">
			<img src="/static/assets/fruitTreeRoot.png" alt="fruit tree root" style="aspect-ratio: 1; height: 17.5em;">
		</div>
		...
		<div class="grid-item" id = "garden_image" data-aos="fade-right">
			<img src="/static/assets/fruitTreeGarden.png.jpg" alt="fruit tree garden" style="aspect-ratio: 2.648; height: 17.5em;">
