    ...
    <body>
        ...
        <section id = "header">
            ...
            <pre id = "load2">As you walk further into our Eco-Trail, you will be greeted by
...
Welcome to the wetland zone!
        ...
        <section id = "section2">
            <div class = "Wetlands fullheight grid2">
                ...
                <p class = "center grid-items hidden">Wetlands are common all throughout the world. They can be
        ...
        <section class = "Wetlands fullheight" id = "Wetlands_What">
            ...
            <p class = "center C3FFED fadetop bottom hidden">Our freshwater marsh wetland is a shallow area of land that is
                covered by water and predominantly dotted with emergent plants.</p>
        </section>

        <section id = "section5">
            <div class = "Wetlands grid2">
        ...
        <section class = "Wetlands fullheight grid2" id = "Mangrove1">
            ...
            <p class = "C3FFED grid-items hidden">Right beside the main wetland, you can find the mangrove section. In collaboration with
        ...
        <section class = "Wetlands fullheight" id = "Mangrove2">
            <div class = "grid">
                ...
                <p class = "C3FFED floatLeft" id = "gridB">The muddy waters of coastal wetlands are extremely carbon-rich and mangrove plants help to sequester
                    large amounts of carbon as they grow.</p>
                <div id = "gridC"></div>
            </div>
        </section>

        <section class = "fullheight grid" id = "Mangrove3">
            <div class = "grid-items"></div>
            <div class = "grid-items">
                <p class = "floatRight">The trees are coastal guardians as they help prevent coastal erosion while providing a habitat for various
                    aquatic animals.
                </p>
            </div>
        </section>
        ...
        <section id = "section13">
            <div class = "grid">
                <p class = "floatLeft">It is important to protect these forests in order to protect our coasts and biodiversity to thrive</p>
                <div></div>
            </div>
        </section>
